...
//协议的类型
    ...
    public:
        ...
        void setOnConnectMessage(const Callback::ProxyOnConnect &cb);

        void setOnDisConnectMessage(const Callback::MQTTProtocolOnDisConnect &cb);

        void setOnSubscribeMessage(const Callback::ProxyOnSubscribe &cb);

        void setOnUnSubscribeMessage();

        void setOnPublishMessage(const Callback::ProxyOnPublish &cb);
